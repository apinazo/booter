...
public class PersonRepositoryTest {
    ...
    public void before() {
        ...
        person01.setPersonalId(personalId);
        person01.addPet(cat);
        person01.addPet(dog);
    ...
    @Test
    public void findPersonByPersonalId_WhenReturned_ShouldBeMe() {

        Person person = this.personRepository.findByPersonalId(personalId);
