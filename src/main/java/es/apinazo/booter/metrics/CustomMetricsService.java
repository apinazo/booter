package es.apinazo.booter.metrics;
 ...
 * and increase them.
 *
 * In Spring Boot 2, metrics are now built upon @see <a href="https://micrometer.io/docs">Micrometer</a>.
 *
 * In this example, metrics will available at this endpoints.
 *
 * All metrics for the counter:
 * <p>http://localhost:8000/actuator/metrics/page.visitors</p>
 *
 * Metrics for a given tag:
 * <p>http://localhost:8000/actuator/metrics/page.visitors?tag=age:30s</p>
 */
@Slf4j
@Service
